    ...
    public Observable<List<NotificationWrapper>> _fetchNotifications()
    {
                            ...
                            public List<NotificationWrapper> call(List<Notification> notifications)
                            {
                                ...
                                for (Notification notification : notifications)
                                {
                                    NotificationWrapper.NotificationItem notificationItem =
                                            new NotificationWrapper.NotificationItem(NotificationWrapper.NotificationItem.Type.EVENT_REMOVED,
                                                    notification.getMessage());

                                    NotificationWrapper notificationWrapper =
                                            new NotificationWrapper(NotificationWrapper.Type.EVENT_REMOVED,
                                                    null,
                ...
                notificationCache
                        ...
                        .map(new Func1<List<Notification>, List<NotificationWrapper>>()
                        {
                            ...
                            public List<NotificationWrapper> call(List<Notification> notifications)
                            {
                                ...
                                {
                                    NotificationWrapper.NotificationItem notificationItem =
                                            new NotificationWrapper.NotificationItem(NotificationWrapper.NotificationItem.Type.INVITATION,
                                                    notification.getMessage());

                                    NotificationWrapper notificationWrapper =
                                            new NotificationWrapper(NotificationWrapper.Type.EVENT_INVITATION,
                ...
                notificationCache
                        ...
                        .map(new Func1<List<Notification>, List<NotificationWrapper>>()
                        {
                            ...
                            public List<NotificationWrapper> call(List<Notification> notifications)
                            {
                                ...
                                {
                                    NotificationWrapper.NotificationItem notificationItem =
                                            new NotificationWrapper.NotificationItem(NotificationWrapper.NotificationItem.Type.NEW_FRIEND_JOINED_APP,
                                                    notification.getMessage());

                                    NotificationWrapper notificationWrapper =
                                            new NotificationWrapper(NotificationWrapper.Type.NEW_FRIEND_JOINED_APP,
                                                    null,
                                                    notification.getEventName(),
                                                    Collections.singletonList(notification.getId()),
                                                    Collections.singletonList(notificationItem),
                        ...
                        .map(new Func1<List<Notification>, List<NotificationWrapper>>()
                        {
                            ...
                            public List<NotificationWrapper> call(List<Notification> notifications)
                            {
                                ...
                                for (Notification notification : notifications)
                                {
                                    ...
                                    if (type == Notification.EVENT_UPDATED || type == Notification.CHAT || type == Notification.RSVP)
                                    {
                                        NotificationWrapper.NotificationItem item = null;
                                        if (type == Notification.EVENT_UPDATED)
                                        {
                                            item = new NotificationWrapper.NotificationItem(NotificationWrapper.NotificationItem.Type.EVENT_UPDATED, notification
                                                    .getMessage());
                                        }
                                        else if (type == Notification.CHAT)
                                        {
                                            item = new NotificationWrapper.NotificationItem(NotificationWrapper.NotificationItem.Type.NEW_CHAT, notification
                                                    .getMessage());
                                        }
                                        else
                                        {
                                            item = new NotificationWrapper.NotificationItem(NotificationWrapper.NotificationItem.Type.FRIEND_JOINED_EVENT, notification
                                                    .getMessage());
                                        }
        ...
        return Observable
                .zip(deleteNotifications,
                        ...
                        new Func4<List<NotificationWrapper>, List<NotificationWrapper>, List<NotificationWrapper>,
                                List<NotificationWrapper>, List<NotificationWrapper>>()
                        {
                            @Override
                            public List<NotificationWrapper> call(List<NotificationWrapper> deleteNotifications,
                                                                  List<NotificationWrapper> invitationNotifications,
                                                                  List<NotificationWrapper> newFriendsNotifications,
                                                                  List<NotificationWrapper> activityNotifications)
                            {
                                ...
                                List<NotificationWrapper> notifications = new ArrayList<>(notificationSet);
